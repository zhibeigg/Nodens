...
object JobCondition: ICondition {
    ...
    override val keywords by ReloadAwareLazy(Nodens.config) { Nodens.config.getStringList("condition.job.keywords") }

    val pattern by ReloadAwareLazy(Nodens.config) { Nodens.config.getMap("condition.job.pattern") }
